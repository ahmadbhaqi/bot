...
# RonzzPay DINONAKTIFKAN — layanan dihapus, gateway default ke Pakasir.
# Set paksa False meski API key terisi agar tidak diinisialisasi.
RONZZPAY_ENABLED: bool = False
